...
Before the five conditions: why these are facets of a single broken system, not a checklist. Draws on the cross-cutting precedent in `research/victory-conditions.md` — the UN poverty roadmap's own diagnosis that conflict, climate, inequality, and debt servicing compound across every domain at once.

## Five sections, each split into two jobs

For each of the five victory conditions:

1. **Open borders / free movement**
2. **One currency**
3. **Food security**
4. **Housing security**
